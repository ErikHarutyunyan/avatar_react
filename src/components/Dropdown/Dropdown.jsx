  ...
  return (
    <div className="relative" ref={ref}>
      <div className="mb-5 text-1xl font-semibold">
        ...
        {type === "Background" && t("sectionGreenscreenTitle")}
      </div>
      <button
        id="dropdownDividerButton"
        data-dropdown-toggle="dropdownDivider"
        className={`${c} text-gray w-96  hover:bg-gray-100  focus:outline-none font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center justify-between`}
        type="button"
        onClick={(e) => {
